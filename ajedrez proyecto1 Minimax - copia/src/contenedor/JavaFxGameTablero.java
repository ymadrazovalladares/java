...
public class JavaFxGameTablero {
    ...
    private Integer xMinimax;
    private Integer yMinimax;
    ...
    {
        this.tablero[0][0].addIdFicha("torre1","blanco", "torreB",50);
        this.tablero[0][1].addIdFicha("caballo1","blanco","caballoB",30);
        this.tablero[0][2].addIdFicha("alfil1","blanco", "alfilB",30);
        this.tablero[0][3].addIdFicha("reina","blanco","reinaB",90);
        this.tablero[0][4].addIdFicha("rey","blanco","reyB",900);
        this.tablero[0][5].addIdFicha("alfil2","blanco","alfilB",30);
        this.tablero[0][6].addIdFicha("caballo2","blanco","caballoB",30);
        this.tablero[0][7].addIdFicha("torre2","blanco","torreB",50);
        this.tablero[1][0].addIdFicha("peon1","blanco","peonB",10);
        this.tablero[1][1].addIdFicha("peon2","blanco","peonB",10);
        this.tablero[1][2].addIdFicha("peon3","blanco","peonB",10);
        this.tablero[1][3].addIdFicha("peon4","blanco","peonB",10);
        this.tablero[1][4].addIdFicha("peon5","blanco","peonB",10);
        this.tablero[1][5].addIdFicha("peon6","blanco","peonB",10);
        this.tablero[1][6].addIdFicha("peon7","blanco","peonB",10);
        this.tablero[1][7].addIdFicha("peon8","blanco","peonB",10);

  }

    public void PiezasNegras()
    {
        this.tablero[7][0].addIdFicha("torre1","negro","torre",50);
        this.tablero[7][1].addIdFicha("caballo1","negro","caballo",30);
        this.tablero[7][2].addIdFicha("alfil1","negro", "alfil",30);
        this.tablero[7][3].addIdFicha("reina","negro", "reina",90);
        this.tablero[7][4].addIdFicha("rey","negro","rey",900);
        this.tablero[7][5].addIdFicha("alfil2","negro","alfil",30);
        this.tablero[7][6].addIdFicha("caballo2","negro","caballo",30);
        this.tablero[7][7].addIdFicha("torre2","negro","torre",50);
        this.tablero[6][0].addIdFicha("peon1","negro","peon",10);
        this.tablero[6][1].addIdFicha("peon2","negro","peon",10);
        this.tablero[6][2].addIdFicha("peon3","negro","peon",10);
        this.tablero[6][3].addIdFicha("peon4","negro","peon",10);
        this.tablero[6][4].addIdFicha("peon5","negro","peon",10);
        this.tablero[6][5].addIdFicha("peon6","negro","peon",10);
        this.tablero[6][6].addIdFicha("peon7","negro","peon",10);
        this.tablero[6][7].addIdFicha("peon8","negro","peon",10);
    ...
    public void Minimax()
    {
        ...
        if(ficha!="")
        {
            ...
            tablero[yMinimax][xMinimax].setSombreada(true);
            if(!MovimientoMiniMax(tablero[yMinimax][xMinimax]))
                Minimax();
        }
        else
        {
    ...
    public Integer MayorPonderacionContraria()
    {
        String ficha = "";
        PosicionHacker temp = new PosicionHacker();
        Integer x = 10;
        Integer y = 10;
        Integer mayorPonder = 0;
        for(int i = 0; i < hacker.getHackerNegro().length;i++)
        {
            temp = hacker.getHackerNegro()[i].getInicioLista();
            while (temp != null)
            {
                String a = tablero[temp.getValorY()][temp.getValorX()].getFicha().getIdFicha();
                if(a!= "")
                { Integer b = GetPonderacion(tablero[temp.getValorY()][temp.getValorX()].getFicha().getIdFicha());
                            ...
                            && c == "blanco")
                    {
                        x = temp.getValorX();
                        y = temp.getValorY();
                        ficha = hacker.getHackerNegro()[i].getNombreFicha();
                        mayorPonder = GetPonderacion(tablero[temp.getValorY()][temp.getValorX()].getFicha().getIdFicha());
                    }
                }
                temp = temp.getSiguiente();
            }
    ...
    public Integer GetPonderacion(String aFicha)
    {
        if(aFicha.contains("peon"))
            return 10;
        else if(aFicha.contains("alfil"))
            return 30;
        else if(aFicha.contains("caballo"))
            return 30;
        else if(aFicha.contains("torre"))
            return 50;
        else if(aFicha.contains("reina"))
            return 90;
        else if(aFicha.contains("rey"))
            return 900;
        else
            return 0;
    }
