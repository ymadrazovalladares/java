...
public  class JavaFxGamePrincipal extends Application {
    ...
    public void start(Stage primaryStage)  {
        ...
        Cliente_Servidor();
        JavaFxGameTablero javaFxGameTablero= new JavaFxGameTablero(Servidorcliente,cliente,servidor);
        if(!Servidorcliente)
            cliente.setTablero(javaFxGameTablero);
        else
            servidor.setTablero(javaFxGameTablero);
