...
grid on;
xlabel ('t (segundos)');
title ('Suma de Señales S1+S2+S3+S4+S5+S6');
...
xlabel ('t (segundos)');
grid on;
title ('Suma de la señal S1 con incremento de amplitud 450');
...
plot(t,s1,'LineWidth',2);
grid on;
title ('Señal sinusoidal coseno con amplitud 55 con 2t');
...
plot(t,s1,'LineWidth',2);
grid on;
title ('Señal sinusoidal seno con amplitud 30 con 3t');
...
plot(t,s1,'LineWidth',2);
grid on;
title ('Señal sinusoidal coseno con amplitud 19 con 5t');
axis([0 1E-12 -20 20]);
...
plot(t,s1,'LineWidth',2);
grid on;
title ('Señal sinusoidal seno con amplitud 6 con 7t');
axis([0 1E-12 -10 10]);
...
plot(t,s1,'LineWidth',2);
grid on;
title ('Señal sinusoidal coseno con amplitud 3 con 10t');
axis([0 1E-12 -5 5]);
...
grid on;
xlabel ('t (segundos)');
title ('Suma de Señales S1+S3+S5');
axis([0 1E-12 -330 300]);
...
plot(t,ST,'LineWidth',2);
xlabel ('t (segundos)');
title ('Suma de las señales con incremento de amplitud en S1 450');
grid on;
axis([0 1E-12 -800 800]);
